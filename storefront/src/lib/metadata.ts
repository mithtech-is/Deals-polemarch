...
export async function generateDealMetadata(id: string): Promise<Metadata> {
    ...
    const description = `Invest in ${deal.name} unlisted shares at ₹${deal.price.toLocaleString('en-IN')}. ${deal.summary} Get verified listings, direct demat credit, and secure transactions at Polemarch.`;
